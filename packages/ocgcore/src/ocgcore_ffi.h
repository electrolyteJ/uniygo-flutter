#ifndef OCGCORE_FFI_H_
#define OCGCORE_FFI_H_
...
typedef uint32_t (*card_reader)(uint32_t code, struct card_data* data);
...
int32_t query_card(intptr_t pduel, uint8_t playerid, uint8_t location, uint8_t sequence, int32_t query_flag, byte* buf, int32_t use_cache);
...
#define MASTER_RULE3 3
#define NEW_MASTER_RULE 4
#define MASTER_RULE_2020 5
...
#define LOCATION_DECKBOT 0x10001
#define LOCATION_DECKSHF 0x20001

#define SEQ_DECKTOP 0
#define SEQ_DECKBOTTOM 1
#define SEQ_DECKSHUFFLE 2
