      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: panelDark,
            border: Border.all(color: const Color(0x4D00F0FF)), // rgba(0, 240, 255, 0.3)
            borderRadius: BorderRadius.circular(8),
            boxShadow: const [
              BoxShadow(
            ...
            children: [
              ...
              Container(
                ...
                child: ListView.separated(
                  ...
                  separatorBuilder: (context, index) => const Divider(color: Colors.white12, height: 4, thickness: 0.5),
                  itemBuilder: (context, index) {
                    if (logs.isEmpty) {
                      return const Text('等待决斗开始...', style: TextStyle(color: Colors.white24, fontSize: 10));
                    }
                    ...
                    return Padding(
                      ...
                      child: Text(
                        log,
                        style: TextStyle(
                          color: isHighlight ? cyanGlow : const Color(0xFF8B9BB4),
                          fontSize: 10,
                          height: 1.5,
