...
class HandCardsBar extends StatefulWidget {
  ...
  final Function(int code)? onCardTap;
        ...
        child: SingleChildScrollView(
          ...
          child: Row(
            ...
            children: widget.handCodes.asMap().entries.map((entry) {
              ...
              final double arcFactor = (1.0 - (absRelative / maxAbs)).clamp(0.0, 1.0);
              ...
              return Padding(
                padding: const EdgeInsets.symmetric(horizontal: 4), // 对应 gap: 8px (左右各4)
                child: MouseRegion(
                  ...
                  child: GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      transform: Matrix4.identity()
                        ...
                        ..translate(0.0, -yArc - (isActive ? 20.0 : 0.0), 0.0) // .hand-card-item:hover { translateY(-20px) }
                        ..rotateZ(rotation)
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            ...
                            color: isActive ? const Color(0xFF00F0FF) : const Color(0xFFFFD700),
                            width: 1.5,
                          ),
                          boxShadow: [
                            BoxShadow(
