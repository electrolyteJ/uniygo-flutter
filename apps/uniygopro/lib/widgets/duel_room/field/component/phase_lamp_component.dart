...
class PhaseLampComponent extends PositionComponent
  ...
  static final _refBoardY = DuelFieldLayout.phaseLampRefBoardY; // 100 (monsterY)
  ...
  Vector2 _projectedPosition() {
    final w = size.x;
    final h = size.y;
    final dx = (DuelFieldLayout.slotWidth + w) / 2 + DuelFieldLayout.phaseLampGap;
    final dy = -((DuelFieldLayout.slotHeight + h) / 2 + DuelFieldLayout.phaseLampGap);
