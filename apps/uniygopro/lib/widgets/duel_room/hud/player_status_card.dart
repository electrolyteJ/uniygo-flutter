...
class PlayerStatusCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const oppPink = Color(0xFFFF9FBB); // v10 .opp .lp
    final borderColor = isSelf
        ? cyanGlow.withValues(alpha: 0.3)
        : const Color(0xFFFF4B82).withValues(alpha: 0.34);
    final shadowColor = isSelf ? cyanGlow : const Color(0xFFFF4B82);
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    if (handCount != null) ...[
                      _buildCountText('HAND', handCount!),
                    ...
                    const SizedBox(width: 6),
                    _buildCountText('B', removedCount, onTap: onRemovedTap),
                  ],
                ),
              ),
            ],
