...
Rect cardDetailDrawerRect(DuelRoomLayoutSpec spec) {
  final left = (spec.safeRect.left + spec.panelGap)
      ...
      .toDouble();
  final top = 124.0 > spec.safeRect.top + spec.topHudHeight + 8
      ? 124.0
      : spec.safeRect.top + spec.topHudHeight + 8;
  final bottomInset = 160.0 > spec.safePadding.bottom + spec.panelGap
      ? 160.0
                    ...
                    child: Semantics(
                      ...
                      child: GestureDetector(
                        ...
                        child: const SizedBox.square(
                          dimension: 44,
                          child: Center(
                            child: Icon(Icons.close, color: cyanGlow, size: 18),
                          ),
                        ),
                      ),
                    ),
